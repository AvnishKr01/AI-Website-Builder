...
interface EditorPanelProps {
    ...
    onUpdate: (upadtes: any) => void;
    onClose: () => void;
}

const EditorPanel = ({ selectedElement, onUpdate, onClose }: EditorPanelProps) => {
     console.log("EditorPanel Rendered", selectedElement);
    ...
    return (
        <div className="fixed top-4 right-4 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 z-50 animate-in">
