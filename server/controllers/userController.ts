...
export const createUserProject = async (req: Request, res: Response) => {
    ...
    try {
        ...
        if (user && user.credits < 5) {
            return res.status(403).json({ message: 'Add more credits to create project' })
        }
            ...
            messages: [
                {
                    ...
                    content: `You are a prompt enhancement specialist. 
                              Take the user's website request and expand it into a detailed, 
...
//             success_url: `${process.env.TRUSTED_ORIGIN}/payment-success`,
//             cancel_url: `${process.env.TRUSTED_ORIGIN}`,
//             line_items: [
//                 {
//                     price_data: {
//                         currency: 'usd',
